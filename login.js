...
function login(event) {
    ...
    if (email.validity.valid) {
        ...
        setInvalid(email);
        hasError = true;
        document.getElementById('login-email-feedback').innerHTML = 'Something did not work with your email address';
    } else {
        setInvalid(email);
        hasError = true;
        document.getElementById('login-email-feedback').innerHTML = 'Something did not work with your email address';
    ...
    if (password.value.trim().length == 0) {
        setInvalid(password);
        hasError = true;
        document.getElementById('login-password-feedback').innerHTML = 'Something did not work with your password';
    } else {
        setValid(password);
    }
...
function register(event) {
    ...
    if (firstName.value.trim().length == 0) {
        ...
        hasError = true;
        document.getElementById('register-firstname-feedback').innerHTML = 'Something did not work with your first name';
    ...
    if (lastName.value.trim().length == 0) {
        setInvalid(lastName);
        hasError = true;
        document.getElementById('register-lastname-feedback').innerHTML = 'Something did not work with your last name';
    ...
    if (email.validity.valid) {
        ...
        setInvalid(email);
        hasError = true;
        document.getElementById('register-email-feedback').innerHTML = 'Something did not work with your email address';
    } else {
        setInvalid(email);
        hasError = true;
        document.getElementById('register-email-feedback').innerHTML = 'Something did not work with your email address';
    ...
    if (passwordValue.length < 8) {
        setInvalid(password);
        hasError = true;
        document.getElementById('register-password-feedback').innerHTML = 'Your password needs to be at least 8 characters long.';
    } else if (passwordValue.length > 16) {
        setInvalid(password);
        hasError = true;
        document.getElementById('register-password-feedback').innerHTML = 'Your password cannot be longer than 16 characters.';
    } else if (passwordValue.match(/[a-zA-Z]+/) == null) {
        setInvalid(password);
        hasError = true;
        document.getElementById('register-password-feedback').innerHTML = 'Your password needs to contain at least one letter.';
    } else if (passwordValue.match(/[0-9]+/) == null) {
        setInvalid(password);
        hasError = true;
        document.getElementById('register-password-feedback').innerHTML = 'Your password needs to contain at least one number.';
    } else {
        setValid(password);
    }
    ...
    if (programme.validity.valueMissing) {
        ...
        hasError = true;
        document.getElementById('register-programme-feedback').innerHTML = 'You need to select a programme.';
